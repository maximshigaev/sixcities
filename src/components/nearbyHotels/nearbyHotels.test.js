...
import NearbyHotels from './nearbyHotels.jsx';

const hotels =  [{price: 120, is_premium: true, is_favorite: false, rating: 4, src: `img/apartment-01.jpg`,
...
it(`Correctly renders the NearbyHotels component`, () => {
